...
观点选择：whether,choice,option
{
    ...
    方法
    {
        only via this approach
    }

    谚语
    {
        As an old saying goes:XXX.For us college students, it has an increasingly important significance.谚语解释.The following reasons can account for this issue.
        }
    ...
    3.承上启下
        ...
        Reasons and concrete evidence to support my view point are as follows.（the followings are）

}
第二段{
        3x（论点+论据）
        In the first place,there is no doubt that XXX.
        ----Based on big data, most successful social elites admitted that they've spent 2/3 of their time in facing challenges.

        Moreover, no one can deny that XXX.
...
第三段{
    ...
    2.展望：未来，人生，社会
    If we spare no efforts to XXX.The future of XXX will be both hopeful and rosy.
    }
    3.重申
...
students,freshman,citizens,residents,staff,parents,patients,
**群体**
